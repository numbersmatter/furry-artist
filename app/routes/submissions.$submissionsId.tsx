...
import { changeReviewStatus, getSectionResponses, getSubmissionStatusByIntentId } from "~/server/database/submission.server";
  ...
  return (
    <article className="px-2 py-2">
      <div className=" rounded-xl  border-4 px-4 py-3 max-w-3xl">
        <div>
          <h2 className="text-2xl font-semibold leading-6 text-gray-900 capitalize">{submission.submissionId}</h2>
        ...
        <div className="divide-y-2 divide-slate-600">
          ...
          <StatusForm submitId={submission.submissionId} />
        </div>
      </div>
    </article>
  );
